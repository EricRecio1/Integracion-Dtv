...
{
    public partial class DtvRecepSucur
    {
        public DtvRecepSucur()
        {
            DtvRecepProdus = new HashSet<DtvRecepProdu>();
        }
        ...
        public virtual ICollection<DtvRecepProdu> DtvRecepProdus { get; set; }
    }
}
